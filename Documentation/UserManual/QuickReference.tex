...
\defSub{age\_weight\_labels} {R,The labels for the \command{$age\_weight$} block which corresponds to each category, if you want to use that weight calculation method for biomass calculations,}
