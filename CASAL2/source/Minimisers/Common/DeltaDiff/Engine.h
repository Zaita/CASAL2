...
//============================================================================
#ifndef USE_AUTODIFF
#ifndef MINIMISERS_DELTADIFF_ENGINE_H_
...
public:
  Engine();
  virtual                     ~Engine();
  double optimise_finite_differences(deltadiff::CallBack& objective, vector<double>& StartValues, vector<double>& LowerBounds,
...
#endif /* MINIMISERS_DELTADIFF_ENGINE_H_ */
#endif
