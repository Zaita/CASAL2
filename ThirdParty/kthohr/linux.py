  ...
  def start(self):   
    ...
    if build_lapack:
        ...
        if os.path.exists(lapackFileName + '.7z'):
            os.system('7za x -bd -y ' + lapackFileName + '.7z 1> lapack_unzip.log 2>&1') 
        else:
        ...
        print('-- Compiling....')
        os.system('make > casal2_build.log 2>&1')
    ...
    if build_kthohr:
        ...
        if os.path.exists(kthohrFileName + '.7z'):
            os.system('7za x -bd -y ' + kthohrFileName + '.7z 1> kthohr_unzip.log 2>&1') 
        else:
